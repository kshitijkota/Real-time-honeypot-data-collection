...
-- 2️⃣ Analyst Role - read-only, can run complex queries
...
CREATE USER 'etl_service'@'localhost' IDENTIFIED BY 'etlpass';
CREATE USER 'analyst'@'localhost' IDENTIFIED BY 'analystpass';
CREATE USER 'honeypot_admin'@'localhost' IDENTIFIED BY 'adminpass';
